...
% 1º Semestre
disciplina_obrigatoria("MAT0025", 6, true, "CALCULO 1").
disciplina_obrigatoria("CIC0004", 6, true, "ALGORITMOS E PROGRAMACAO DE COMPUTADORES").
...
disciplina_obrigatoria("FGA0163", 4, true, "INTRODUCAO A ENGENHARIA").
